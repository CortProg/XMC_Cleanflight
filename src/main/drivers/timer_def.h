...
#define DEF_TIM(tim, chan, global, ccu8, pin, flags, out) {                           \
    (uint32_t*)tim,																\
	(uint32_t*)global,															\
	(uint8_t)ccu8,														\
    IO_TAG(pin),                                                        \
...
#define DEF_TIM_CHANNEL(ch)        CONCAT(DEF_TIM_CHANNEL__, DEF_TIM_CH_GET(ch))
#define DEF_TIM_CHANNEL__D(chan_n, n_channel) (chan_n-1)

#define DEF_TIM_AF(timch, pin)     CONCAT(DEF_TIM_AF__, DEF_TIM_AF_GET(timch, pin))
#define DEF_TIM_AF__D(af_n) XMC_GPIO_MODE_OUTPUT_ALT ## af_n
...
// AF table //D(x) -> which port function see 668
#define DEF_TIM_AF__P13__TCH_CCU40_CC40_CH1     D(3)
#define DEF_TIM_AF__P12__TCH_CCU40_CC41_CH1     D(3)
#define DEF_TIM_AF__P11__TCH_CCU40_CC42_CH1     D(3)
#define DEF_TIM_AF__P10__TCH_CCU40_CC43_CH1     D(3)

#define DEF_TIM_AF__P25__TCH_CCU41_CC40_CH1     D(3)
#define DEF_TIM_AF__P24__TCH_CCU41_CC41_CH1     D(3)
#define DEF_TIM_AF__P23__TCH_CCU41_CC42_CH1     D(3)
#define DEF_TIM_AF__P22__TCH_CCU41_CC43_CH1     D(3)

#define DEF_TIM_AF__P36__TCH_CCU42_CC40_CH1     D(3)
#define DEF_TIM_AF__P35__TCH_CCU42_CC41_CH1     D(3)
#define DEF_TIM_AF__P34__TCH_CCU42_CC42_CH1     D(3)
#define DEF_TIM_AF__P33__TCH_CCU42_CC43_CH1     D(3)

#define DEF_TIM_AF__P46__TCH_CCU43_CC40_CH1     D(3)
#define DEF_TIM_AF__P45__TCH_CCU43_CC41_CH1     D(3)
#define DEF_TIM_AF__P44__TCH_CCU43_CC42_CH1     D(3)
#define DEF_TIM_AF__P43__TCH_CCU43_CC43_CH1     D(3)

#define DEF_TIM_AF__P05__TCH_CCU80_CC80_CH1     D(3)
#define DEF_TIM_AF__P010__TCH_CCU80_CC80_CH2    D(3)
#define DEF_TIM_AF__P04__TCH_CCU80_CC81_CH1     D(3)
#define DEF_TIM_AF__P09__TCH_CCU80_CC81_CH2     D(3)
#define DEF_TIM_AF__P03__TCH_CCU80_CC82_CH1     D(3)
#define DEF_TIM_AF__P29__TCH_CCU80_CC82_CH2     D(3)
#define DEF_TIM_AF__P06__TCH_CCU80_CC83_CH1     D(3)
#define DEF_TIM_AF__P28__TCH_CCU80_CC83_CH2     D(3)

#define DEF_TIM_AF__P115__TCH_CCU81_CC80_CH1    D(3)
#define DEF_TIM_AF__P57__TCH_CCU81_CC80_CH2     D(3)
#define DEF_TIM_AF__P114__TCH_CCU81_CC81_CH1    D(3)
#define DEF_TIM_AF__P55__TCH_CCU81_CC81_CH2     D(3)
#define DEF_TIM_AF__P113__TCH_CCU81_CC82_CH1    D(3)
#define DEF_TIM_AF__P53__TCH_CCU81_CC82_CH2     D(3)
#define DEF_TIM_AF__P61__TCH_CCU81_CC83_CH1     D(3)
#define DEF_TIM_AF__P51__TCH_CCU81_CC83_CH2     D(3)
