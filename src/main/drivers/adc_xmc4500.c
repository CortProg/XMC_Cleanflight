...
//	{ .group = VADC_G0, .channels = {3, 2, 1}, .trigger_input = XMC_VADC_REQ_TR_A, .irq = VADC0_G0_0_IRQn},
//	{ .group = VADC_G1, .channels = {4, 5, 6}, .trigger_input = XMC_VADC_REQ_TR_A, .irq = VADC0_G1_0_IRQn},
//	{ .group = VADC_G2, .channels = {3, 4, 5}, .trigger_input = XMC_VADC_REQ_TR_A, .irq = VADC0_G2_0_IRQn},
//	{ .group = VADC_G3, .channels = {4, 5, 6}, .trigger_input = XMC_VADC_REQ_TR_A, .irq = VADC0_G3_0_IRQn},
};
#endif
