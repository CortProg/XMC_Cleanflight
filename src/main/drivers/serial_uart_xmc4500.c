...
const uartHardware_t uartHardware[UARTDEV_COUNT] = {
#ifdef USE_UART1
    {
        ...
        .rxPins = { DEFIO_TAG_E(P04), DEFIO_TAG_E(P05), DEFIO_TAG_E(P215), DEFIO_TAG_E(P214) },//DXx channels on XMC depends on placement here
        .txPins = { DEFIO_TAG_E(P05), DEFIO_TAG_E(P214) },
...
#ifdef USE_UART2
    {
		...
		.rxPins = { DEFIO_TAG_E(P315), DEFIO_TAG_E(P314), DEFIO_TAG_E(P42), DEFIO_TAG_E(P00) },
        .txPins = { DEFIO_TAG_E(P01), DEFIO_TAG_E(P315), DEFIO_TAG_E(P42), IO_TAG_NONE },
        .af = XMC_GPIO_MODE_OUTPUT_ALT2,
...
#ifdef USE_UART3
    {
        ...
        .rxPins = { DEFIO_TAG_E(P51), DEFIO_TAG_E(P50), DEFIO_TAG_E(P37), IO_TAG_NONE },
        .txPins = { DEFIO_TAG_E(P38), DEFIO_TAG_E(P50), IO_TAG_NONE, IO_TAG_NONE },
        .af = XMC_GPIO_MODE_OUTPUT_ALT1,
        .irqn_tx = USIC2_0_IRQn,
		.irqn_rx = USIC2_1_IRQn,
