...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
	    ...
	    DEF_TIM(CCU41_CC40, CH1, CCU41, 0, P25, TIM_USE_MOTOR, 0),
		DEF_TIM(CCU41_CC41, CH1, CCU41, 0, P24, TIM_USE_MOTOR, 0),
		DEF_TIM(CCU41_CC42, CH1, CCU41, 0, P23, 0, 0),
		DEF_TIM(CCU41_CC43, CH1, CCU41, 0, P22, 0, 0),
	    DEF_TIM(CCU42_CC40, CH1, CCU42, 0, P36, TIM_USE_MOTOR, 0),
		DEF_TIM(CCU42_CC41, CH1, CCU42, 0, P35, TIM_USE_MOTOR, 0),
		DEF_TIM(CCU42_CC42, CH1, CCU42, 0, P34, TIM_USE_MOTOR, 0),
		DEF_TIM(CCU42_CC43, CH1, CCU42, 0, P33, TIM_USE_MOTOR, 0),
	    DEF_TIM(CCU43_CC40, CH1, CCU43, 0, P46, TIM_USE_MOTOR, 0),
		DEF_TIM(CCU43_CC41, CH1, CCU43, 0, P45, TIM_USE_MOTOR, 0),
